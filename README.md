...
Code for the tutorials from the course Humanoid Robotic Systems at TUM. In these tutorials, ROS was used for the control of the [NAO Robot](https://www.softbankrobotics.com/emea/en/nao). Tutorials 3 and 4 were an introduction to computer vision using NAO's camera and tutorials 5, 6 and 7 implemented movement and other features.
